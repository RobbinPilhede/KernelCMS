...
These are closed commercial platforms; this is our own analysis of their _publicly
positioned_ capabilities, not a copy of their docs. Verify specifics against their
...
Amplience Editions/Events _and_ Bloomreach Projects/branching. Built on versions
...
2. Uploads/media → DAM (Spec 03) · 4. Auth depth · 5. Migrations workflow ·
3. Read-side field access · 7. GraphQL + page-model delivery · 8. Hierarchy/folders/
...
4. Delivery/CDN/perf (X7).

**Module (optional first-party packages/adapters)** 15. Plugin system → SEO/Search/Form Builder/Redirects/Multi-tenant · 16. **Dynamic
...
authoring** (X6) · 21. Email · 22. Jobs queue (enabler for 9/13/19) · 23. Webhooks · 24. Analytics (X8).

**Adjacent (integration adapters, not core)** 25. CDP / marketing automation (Bloomreach Engagement, Part D) · 26. Commerce
...
> and CDP). Trying to _build_ all of them into one CMS would dilute the product. The
